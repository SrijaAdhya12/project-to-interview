    updated on: 25th March 2025, Tuesday
...
2. Go to [**Security**](https://github.com/warmachine028/project-to-interview/security) tab.
3. Click on **Security Overview**.
4. Click on `Enable Dependabot alerts` button.

- Enable Code Scanning Alerts

1. Go to [Code security and analysis](https://github.com/SrijaAdhya12/project-to-interview/settings/security_analysis#code_scanning_settings) section in settings.
